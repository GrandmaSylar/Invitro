...
const ReceiptSection = React.lazy(() => import('./ReceiptSection'));
...
const SETTINGS_SECTIONS = [
  ...
  { id: 'receipt', label: 'Receipt Template', icon: Receipt, permissionKey: 'settings.general', group: 'General', isMock: false },
